...
var vegetables = ['onions', 'peppers', 'mushrooms', 'spinich', 'tomato']

// Write the code to access the 3rd element of the Array, using bracket
// notation.
console.log(`Yummy, ${vegetables[2]}`)

// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.
var fruits = ['apples', 'oranges', 'bannanas', 'kiwi', 'starfruit', 'tomato', 'mango']

// Write the code to access the 5th element of the array, using bracket notation.
console.log(`Hey man, do you have any ${fruits[4]}?`)
//------------------------- Objects -------------------------//
